    ...
    <section className="relative section" id="plans" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 relative z-10">
        ...
        <div className="md:hidden">
          {/* スワイプヒント */}
          <div className="flex items-center justify-center gap-2 mb-4 text-base text-gray-500">
              ...
              >
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex justify-between py-2 border-b border-gray-200">
                    <span className="text-base font-semibold text-primary">初回応答</span>
                    <span className="text-base text-gray-900">{plan.sla}</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-gray-200">
                    <span className="text-base font-semibold text-primary">会議</span>
                    <span className="text-base text-gray-900">{plan.meeting}</span>
                  </div>
                  {plan.extras && plan.extras.length > 0 && (
                    <div className="py-2">
                      <span className="text-base font-semibold text-primary block mb-2">含まれるサービス</span>
                      <div className="space-y-1.5">
                        {plan.extras.map((x, ix) => (
                          <div key={ix} className="text-base text-gray-900 flex items-start gap-1.5 leading-relaxed">
                ...
                <a
                  href="/contact"
                  className="mt-5 sm:mt-6 block w-full text-center px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg text-base sm:text-lg font-semibold transition-colors bg-white text-gray-900 border border-gray-300 hover:bg-gray-50"
          ...
          <table className="w-full bg-white/95 backdrop-blur-sm rounded-xl border border-gray-200 overflow-hidden shadow-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                <th className="px-4 py-3 text-left text-base font-bold text-gray-700 border-r border-gray-200">プラン</th>
                {plans.map((p, i) => (
                  <th key={i} className={`px-4 py-3 text-center text-base font-bold text-gray-700 ${i < plans.length - 1 ? 'border-r border-gray-200' : ''}`}>
            ...
            <tbody className="divide-y divide-gray-200">
              ...
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="px-4 py-3 text-base font-semibold text-gray-700 border-r border-gray-200">月額料金</td>
                {plans.map((p, i) => {
                  ...
                  return (
                    <td key={i} className={`px-4 py-3 text-center ${i < plans.length - 1 ? 'border-r border-gray-200' : ''}`}>
                      <div className="flex flex-col items-center">
                        <span className="text-xl font-bold text-gray-900">{priceWithoutMonth}</span>
                        <span className="text-base text-gray-900">/月</span>
                      </div>
                    </td>
                  );
                })}
              ...
              {/* 月間稼働 */}
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="px-4 py-3 text-base font-semibold text-gray-700 border-r border-gray-200">月間稼働の目安</td>
                {plans.map((p, i) => (
                  <td key={i} className={`px-4 py-3 text-center text-base text-gray-900 ${i < plans.length - 1 ? 'border-r border-gray-200' : ''}`}>
                    {p.tickets}
                  </td>
                ))}
              </tr>
              {/* SLA */}
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="px-4 py-3 text-base font-semibold text-gray-700 border-r border-gray-200">初回応答</td>
                {plans.map((p, i) => (
                  <td key={i} className={`px-4 py-3 text-center text-base text-gray-900 ${i < plans.length - 1 ? 'border-r border-gray-200' : ''}`}>
                    {p.sla}
                  </td>
              ...
              {/* 会議 */}
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="px-4 py-3 text-base font-semibold text-gray-700 border-r border-gray-200">会議</td>
                {plans.map((p, i) => (
                  <td key={i} className={`px-4 py-3 text-center text-base text-gray-900 ${i < plans.length - 1 ? 'border-r border-gray-200' : ''}`}>
                    {p.meeting}
                  </td>
              ...
              {/* 含まれるサービス */}
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="px-4 py-3 text-base font-semibold text-gray-700 border-r border-gray-200">含まれるサービス</td>
                {plans.map((p, i) => (
                  <td key={i} className={`px-4 py-3 text-center text-base text-gray-900 ${i < plans.length - 1 ? 'border-r border-gray-200' : ''}`}>
                    {p.extras?.map((x, ix) => (
              ...
              <tr className="border-t border-gray-200 bg-gray-50">
                <td className="px-4 py-3 text-base font-semibold text-gray-700 border-r border-gray-200"></td>
                {plans.map((p, i) => (
                  <td key={i} className={`px-4 py-4 text-center ${i < plans.length - 1 ? 'border-r border-gray-200' : ''}`}>
                    <a
                      href="/contact"
                      className="inline-block px-4 py-2 rounded-lg text-base font-semibold transition-colors bg-white text-gray-900 border border-gray-300 hover:bg-gray-50"
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-4">
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-xl border border-blue-100 p-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-bold text-gray-900 text-base">まずは小さく</h3>
            </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-white rounded-xl border border-green-100 p-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-bold text-gray-900 text-base">継続的な改善に</h3>
            </div>
            <p className="text-base text-gray-700 leading-relaxed">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-white rounded-xl border border-purple-100 p-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-bold text-gray-900 text-base">事業成長と共に</h3>
            </div>
            <p className="text-base text-gray-700 leading-relaxed">
        ...
        <div className="mt-6 rounded-xl bg-white border border-gray-200 p-4 text-base text-gray-700 space-y-1">
