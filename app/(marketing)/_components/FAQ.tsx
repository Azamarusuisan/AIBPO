export default function FAQ() {
  const faqs = [
    ...
    {
      q: "なぜこんなに安いのですか？",
      a: "自社でNVIDIAの最高GPUを有しており、そこで完全自動バグ修正システムを自社開発しているため、工数削減と費用削減が実現されています。「機械が時間を削り、人が価値を出す」というコンセプトのもと、自動化できる部分はAIに任せ、人手は難所に集中することで、相場より大幅に安い価格を実現しています。具体的には、テストコード生成、バグの完全自動デバッグ、コードレビューの一次チェックなどをAIが担当し、最終的な判断とアーキテクチャ設計を経験豊富な元PMが行うことで、品質を保ちながらコストを削減しています。また、オンデマンドモデルにより、固定人件費を抑えていることも低価格の理由です。"
    },
    {
      q: "品質はどのように担保されていますか？",
    ...
    },
    {
      ...
      a: "プランの月間時間を超えた場合、超過時間として¥6,500〜7,000/hで対応可能です。また、夜間・休日対応が必要な場合は+20%のスピードオプションが適用されます。それ以外の隠れた追加料金は一切ありません。"
    },
    {
      q: "小規模な修正でも依頼できますか？",
