  ...
  return (
    <section className="section bg-gradient-to-b from-gray-50 to-white">
      <div className="mx-auto max-w-6xl px-6">
        ...
        {/* 追加メッセージ */}
        <div className="mt-12 text-center bg-white rounded-xl p-6 shadow-lg border-2 border-primary/20">
          <p className="text-base md:text-lg font-semibold text-gray-900 mb-2">
            広告費や採用までの時間と労力、<br className="md:hidden" />
            採用後の給与と福利厚生が大幅削減できます
          </p>
          <div className="flex flex-wrap justify-center gap-4 mt-4 text-sm">
            <div className="flex items-center gap-2 text-accent">
              ...
              <span className="font-semibold">経費削減</span>
            </div>
            <div className="flex items-center gap-2 text-accent">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span className="font-semibold">運用の負担軽減</span>
            </div>
            <div className="flex items-center gap-2 text-accent">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span className="font-semibold">柔軟な時間利用</span>
            </div>
          </div>
        </div>
      </div>
